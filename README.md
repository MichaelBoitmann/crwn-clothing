...
git checkout main
```
2. Branch off from main. This will create a new branch where the code of main is the basis for your new branch. You can name your new branch whatever you want! Let's say we use my-main-branch as the name.
```
